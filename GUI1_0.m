...
% Last Modified by GUIDE v2.5 05-Dec-2020 19:12:56
...
%     h = preview(vid1,hImage1);
%     axes(handles.axes2);
%     hImage2=imshow(zeros(usbVidRes1(2),usbVidRes1(1),nBands1));
%     h = preview(vid1,hImage2);
%     int n1 =0;
%     while ishandle(h)
...
%
    while ishandle(h)
        frame = getsnapshot(obj);
        imwrite(frame,['RGBpics\',num2str(toc),'.png']);
        I = rgb2gray(frame);
        imwrite(I,['GRAYpics\',num2str(toc),'.png']);
        axes(handles.axes1);
        imshow(frame);
        axes(handles.axes2);
        imshow(I);
